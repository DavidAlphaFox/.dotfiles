...
(custom-set-variables
 ...
 '(package-selected-packages
	 (quote
		(slime-company yaml-tomato yaml-mode slime-annot popwin popup-switcher popup-kill-ring popup-complete merlin material-theme haskell-snippets fuzzy-match fuzzy-format fuzzy flyspell-popup flyspell-lazy flymake-yaml flymake-shell flymake-hlint flymake-haskell-multi erlang ac-slime ac-haskell-process ac-etags ac-dabbrev))))
(custom-set-faces

...
This function should only modify configuration layer settings."
  (setq-default
    ...
    dotspacemacs-additional-packages '(eldoc shackle eglot)
...
before packages are loaded."
  (load "~/.spacemacs.d/my-configs.el")
  (load "~/.spacemacs.d/my-treemacs.el")
  (load "~/.spacemacs.d/my-lsp.el")
  (load "~/.spacemacs.d/my-lisp.el")
